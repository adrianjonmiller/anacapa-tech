    ...
    */
	...
	function wpv_admin_enqueue_scripts($hook) {// echo $hook; TODO this function needs a lot of love
		...
		*/
		...
		wp_register_script( 'views-redesign-users-js', ( WPV_URL . "/res/js/redesign/views_filter_users.js" ), array( 'suggest', 'views-redesign-filters-js'), null, true );
		...
		wp_register_script( 'views-redesign-usermeta-field-js', ( WPV_URL . "/res/js/redesign/views_filter_usermeta_field.js" ), array( 'views-redesign-filters-js'), null, true );
		...
		wp_register_script( 'views-suggestion_script', ( WPV_URL . "/res/js/redesign/suggestion_script.js" ), array(), null, true );
