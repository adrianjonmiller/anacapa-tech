		...
		<div class="wpv-setting">
			<ul>
				...
				<li>
					...
					<?php $checked = $view_settings['query_type'][0]=='users' ? ' selected="selected"' : ''; ?>
					<option id="wpv-settings-query-type-users" value="users"<?php echo $checked; ?>><?php _e('Users','wpv-views') ?></option>
					</select>
				...
				<li>
					...
					<ul class="wpv-settings-query-type-users">
						<?php global $wp_roles;
