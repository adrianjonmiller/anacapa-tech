        ...
        if (isset($view_layout_settings['style']) && ($view_layout_settings['style'] == 'table_of_fields' or $view_layout_settings['style'] == 'table')) {
            ...
            <script type=\"text/javascript\">
                function wpv_column_head_click_" . $WP_Views->get_view_count() . "(name, direction) {
                    jQuery('form[name=\"wpv-filter-" . $WP_Views->get_view_count() . "\"]').each(function(){
                 ...
                 //   jQuery('form[name=\"wpv-filter-" . $WP_Views->get_view_count() . "\"] #wpv_column_sort_id').val(name);
                 //   jQuery('form[name=\"wpv-filter-" . $WP_Views->get_view_count() . "\"] #wpv_column_sort_dir').val(direction);
...
class Walker_Category_radios extends Walker {
	...
	//		}
    		...
    		$output .= '<span class="radios-taxonomies-title">' . $indent . $tax_option . '</span><input name="'.$name.'" type="radio" value="' . $category->name. '"' . $selected . '/>' . "\n";
        }
	}
